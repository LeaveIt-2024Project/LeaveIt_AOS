...
class ShowPlaceViewRecyclerViewAdapter : ListAdapter<ShowPlaceModel,ShowPlaceViewRecyclerViewAdapter.ShowPlaceViewRecyclerViewHolder>(diffUtil) {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ShowPlaceViewRecyclerViewHolder {
        return ShowPlaceViewRecyclerViewHolder(ItemShowplaceRecyclerviewBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
    ...
    inner class ShowPlaceViewRecyclerViewHolder(private val binding : ItemShowplaceRecyclerviewBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    companion object{
        val diffUtil = object: DiffUtil.ItemCallback<ShowPlaceModel>(){
            override fun areItemsTheSame(oldItem: ShowPlaceModel, newItem: ShowPlaceModel): Boolean {
                return oldItem.contentId==newItem.contentId
            }

            override fun areContentsTheSame(oldItem: ShowPlaceModel, newItem: ShowPlaceModel): Boolean {
