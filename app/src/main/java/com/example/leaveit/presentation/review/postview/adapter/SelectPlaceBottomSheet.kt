...
class SelectPlaceBottomSheet : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.bottom_sheet_selectplace, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val imageView: ImageView = view.findViewById(R.id.ChoosePlaceForReviewImageView)
        val textButton: TextView = view.findViewById(R.id.choosePlaceForReviewBtn)
